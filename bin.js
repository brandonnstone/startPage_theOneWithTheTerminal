...
var bookmarks = [
    ...
    ['palette', 'http://palettegenerator.com'],
...
function weather() {
    ...
    var json_url = "http:api.openweathermap.org/data/2.5/weather?zip=80303&APPID=baac51089d68c75a4e9de6dddd4de54d";
    var city;
    var temp_curr;
    var temp_low;
    var temp_high;
    ...
    $.when(
        ...
        disgusting ? weatherString += "Lame." : weatherString += "Not bad."
        print(weatherString)
	})
}
